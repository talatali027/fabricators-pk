...
{/* Col 1: Brand */}
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-4">
          <a href={BRAND.facebook} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-steel-700 flex items-center justify-center text-chrome-mid hover:bg-chrome-mid hover:text-steel-950 transition-all">
            <Facebook size={18} />
          </a>
          <a href={BRAND.instagram} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-steel-700 flex items-center justify-center text-chrome-mid hover:bg-chrome-mid hover:text-steel-950 transition-all">
            <Instagram size={18} />
          </a>
          <a href={BRAND.whatsappLink} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-steel-700 flex items-center justify-center text-chrome-mid hover:bg-[#25D366] hover:text-white hover:border-[#25D366] transition-all">
            <Phone size={18} />
          </a>
        </div>
      </div>
